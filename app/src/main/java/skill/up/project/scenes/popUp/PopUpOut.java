...
public class PopUpOut {
    private Stage stage;

    public PopUpOut(Stage stage) {
        this.stage = stage;
    }
    ...
    public void show(int id) {
        ...
        BackgroundImage backgroundImage = UIUtil.createBackgroundImage("/images/Home1.png", 740, 480);
        Background background = new Background(backgroundImage);
        root.setBackground(background);

        // Labels
        Label labelHalo = UIUtil.createLabel("Apakah anda yakin untuk keluar?", 220, 190);
        labelHalo.getStyleClass().add("title-text-popup");
